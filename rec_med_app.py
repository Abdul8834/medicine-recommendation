...
if st.button('Find Medicines'):
    if input_reason_description:
        alternatives = find_alternative_medicines(input_reason_description, df)[:5]  # Limit to top 5
        
        st.subheader(f"Top 5 Medicine recommendations for '{input_reason_description}':")
        st.write("")
